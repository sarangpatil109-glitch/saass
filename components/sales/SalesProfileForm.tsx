      ...
      <Card className="p-6 bg-white dark:bg-gray-900 shadow-sm border border-gray-100 dark:border-gray-800">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="px-3 py-2 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-600 font-mono">
              {profile.vendor_code || 'Not Assigned'}
            </div>
          </div>
          <div className="col-span-2 md:col-span-1">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Vendor/Company Name *</label>
            <Input name="vendor_name" defaultValue={profile.vendor_name} placeholder="Enter Vendor Name" required minLength={2} maxLength={100} />
            <p className="text-xs text-gray-400 mt-1">The name of the vendor or company you are working for.</p>
          </div>
        </div>
      </Card>
