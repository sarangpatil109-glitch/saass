...
export default function SalesExecProfilePage() {
  return (
        ...
        <form className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <Input disabled defaultValue="John Doe" className="bg-gray-50" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
              <Input disabled defaultValue="john.doe@example.com" className="bg-gray-50" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Linked Vendor</label>
              <Input disabled defaultValue="GymPro Fitness (VND-XY98A)" className="bg-gray-50" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Commission Rate</label>
              <Input disabled defaultValue="15%" className="bg-gray-50" />
            </div>
            <div>
